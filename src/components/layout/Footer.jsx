...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FaFacebook />, url: "https://www.facebook.com/share/19yVPxNe6H/", label: "Facebook" },
    { icon: <FaLinkedin />, url: "https://linkedin.com/in/hasibulislamniloy", label: "LinkedIn" },
    { icon: <FaGithub />, url: "https://github.com/hasibulnilo", label: "GitHub" },
  ];
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="" className="text-sm opacity-70 hover:opacity-100 hover:text-secondary transition-colors">Terms & Conditions</Link></li>
              <li><Link to="" className="text-sm opacity-70 hover:opacity-100 hover:text-secondary transition-colors">Privacy Policy</Link></li>
              <li><Link to="" className="text-sm opacity-70 hover:opacity-100 hover:text-secondary transition-colors">FAQs</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-sm opacity-70">
                ...
                <span>support@Public Infrastructure Issue Reporting System
.gov</span>
              </li>
              <li className="mt-6">
      ...
      <div className="border-t border-white/5 py-8 bg-black/20">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs opacity-50">
            © {currentYear} <span className="text-primary font-bold tracking-tight">Public Infrastructure Issue Reporting System
</span>. All rights reserved.
          </p>
          <p className="text-xs opacity-50 flex items-center gap-1">
            Developed with <span className="text-secondary">❤️</span> by H.I Niloy
          </p>
        </div>
      </div>
    </footer>
