  ...
  const socialLinks = [
    {
      name: "Facebook",
      icon: <FaFacebook />,
      link: "https://www.facebook.com/share/19yVPxNe6H/",
      color: "hover:text-blue-600",
    },
    {
      name: "LinkedIn",
      icon: <FaLinkedin />,
      link: "linkedin.com/in/hasibulislamniloy",
      color: "hover:text-blue-700",
    },
    {
      name: "GitHub",
      icon: <FaGithub />,
      link: "https://github.com/hasibulnilo",
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-4 group cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">hasibulislamniloy142@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 group cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">+880 1629160947</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-7 p-10">
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="form-control w-full">
                ...
                <input type="text" placeholder="Hasibul Islam" className="input input-bordered w-full rounded-xl focus:border-primary" />
              </div>
              <div className="form-control w-full">
                <label className="label">
                  <span className="label-text font-bold text-gray-700">Last Name</span>
                </label>
                <input type="text" placeholder="Niloy" className="input input-bordered w-full rounded-xl focus:border-primary" />
              </div>
